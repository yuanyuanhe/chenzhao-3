...
class Testtime extends Component{
    ...
    add(){
      ...
      // });
    	...
    	api.healthorderaddOrder(params).then((data)=>{
    		if (tools.checkResult(data)) {
                  tools.toast.success('新增成功')
    ...
    //       policyNo
    //     }
    //     api.getmessage(params).then((data)=>{
    //       if (tools.checkResult(data)) {
    //        let cityCode= tools.Trim(data.orderMessager.cityCode)
    //         this.setState({
    //                    provinceCode1:data.orderMessager.branchCode,
    //                    cityCode:cityCode,
    //                    healthchkPartyId:data.orderMessager.partyId,
    //         })   
              ...
              <div className="main1">
                <div className="box2">
                    ...
                    <p className="slt-appment-ty">
                     <label>请选择体检类型</label>
                        <label><input type="radio" name='testtype' value='03'  defaultChecked={true} onChange={(e)=>this.alone(e)} />个险预约</label>
                         {tools.Power(gexian,this.state.powercode)?<label><input type="radio" name='testtype' value='01' onChange={(e)=>this.alone(e)} />团险预约</label>:null}
                         
                          {tools.Power(gexian,this.state.powercode)||tools.Power(hebao,this.state.powercode)?<label><input type="radio" name='testtype' value='02' onChange={(e)=>this.alone(e)} />预核保无保单预约</label>:null}
                    ...
                    <div>
                        ...
                        <input type="text" className="tl fl width20" name="policyNo" data-input-clear={5} onChange={(e)=>{this.setState({policyNo:tools.policyNoInput(e)})}} value={this.state.policyNo}  onBlur={this.inputOnBlur } />
                        <label className="fl" >营销员代码<Xing/></label>
                        <input type="text" className="tl fl width20"  data-input-clear={5} onChange={(e)=>{this.setState({salesId:e.target.value})}}  name="salesId"  onBlur={()=>this.inputOnBlurs() }/>
                    </div>
                    <div className="clearfix"></div>
                    {/* <div>
                        <label className="fl" >体检人姓名<Xing/></label>
                        <input type="text" className="tl fl width20" placeholder="" data-input-clear={5} onChange={(e)=>{this.setState({personName:e.target.value})}}/>
                        <label className="fl" >营销员电话<Xing/></label>
                        <input type="number" className="tl fl width20" placeholder="" data-input-clear={5} onChange={(e)=>{this.setState({salesTel:e.target.value})}}/>
                    </div>                   */}
                    <div className="clearfix"></div>
                    <div>
                        <label className="fl" >分公司<Xing/></label>

                        <select  onChange={(e)=>this.changeBranch(e.target.value)} value={this.state.provinceCode1} className="fl-none fl width20" name="choose" >
                       ...
                       <select value={this.state.cityCode} onChange={(e)=>this.changeCity(e.target.value)} className="fl-none fl width15" id="cityCode">
	                      <option value="">请选择</option>
                    ...
                    {this.state.testtype==='01'?<div>
                        ...
                        <div>
                            ...
                            <input type="text" className="tl fl width20" placeholder="" data-input-clear={5} onChange={(e)=>{this.setState({certiCode:e.target.value})}} onKeyUp={this.numbers}/>
                        ...
                        <select  onChange={(e)=>this.changeBranch(e.target.value)} value={this.state.provinceCode} className="fl-none fl width20" name="choose" disabled>
                        <option value="" >请选择</option>
                        {this.state.branchList.map((item,index)=>{
                            return(
                                    <option key={index} value={item.provinceCode}>{item.branchName}</option>
                    ...
                    <div><label className="fl" >体检日期</label>
                        ...
                        <div>
                            ...
                            <input type="text" className="tl fl width20" placeholder="" data-input-clear={5} onChange={(e)=>this.setState({salesTel:e.target.value})} onKeyUp={this.numbers} />
                    ...
                    {this.state.testtype==='02'?<div>
                    	<div>
                            ...
                            <label className="fl" >证件号码<Xing/></label>
                            <input type="text" className="tl fl width20" placeholder="证件号码" data-input-clear={5} onChange={(e)=>{this.setState({certiCode:e.target.value})}}  onKeyUp={this.numbers}/>
...
export default withRouter(Testtime)